const Funds = () => {
  return (
    <div className="wrapper  lg:my-[100px] relative py-[80px] sm:py-[150px]">
      <img
        src="/wave.png"
        className="absolute -z-10 max-h-[730px] sm:block hidden top-1/2 -translate-y-1/2 left-1/2 -translate-x-1/2 w-full  object-cover"
        alt=""
      />
